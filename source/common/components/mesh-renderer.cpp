...
namespace our {
    ...
    void MeshRendererComponent::deserialize(const nlohmann::json& data){
        ...
        // Getting the material and the mesh from the AssetLoader by their names
        // AssetLoader is a static class that holds all the assets in the game and can be accessed from anywhere
        // It is a template class so we can use it to get any type of asset by its name
